...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarFooter className={cn("mt-auto border-t", collapsed && "px-2")}>
        <div className={cn("flex flex-col gap-1", collapsed && "items-center")}>
          <a
            href="#"
            className="group flex items-center gap-2 rounded-md px-2 py-1.5 text-sm text-sidebar-foreground transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
          >
